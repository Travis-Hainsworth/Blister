...
% Now make the beautiful plot
shadedErrorBar(load_united, mean_of_displacements, standard_deviation,'lineprops',{'color',coolors(1)}) %change line size
title('Quasi-Static Loading on Bike Rims with Tires')
subtitle('Shaded Region: \pm1 \sigma, n=5')
xlabel('Load (lbs)')
ylabel('Displacement (in)')
%plot(load_united,mean_of_displacements)
lgd = legend('We Are One Union (Carbon Fiber)','DT Swiss (Aluminum Alloy)','Stans Flow MK4 (Aluminum Alloy)');
lgd.FontSize = 16;
