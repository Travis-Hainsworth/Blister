...
test_interval_mm = 30;       % Input the desired distance between data points in mm (multiples of 5 work best)
test_type = 'loaded';        % Test Type (string that is either loaded, unloaded, or torsion)

% Serial USB connections
arudiuno_port = 'COM11';     % write in arduino port
inclinometer_port = 'COM7';  % write in inclometer port
...
seconds_per_rev = 3;         % Roughly how many seconds it takes stepper to complete one revolution ()
...
function [pitch, roll, force1, force2] = collect_sensor_data(inclinometer_port, load_cell1_port, load_cell2_port)
    [pitch, roll]=accel_average(inclinometer_port,1); 
